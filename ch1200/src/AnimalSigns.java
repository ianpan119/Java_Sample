...
public class AnimalSigns {
  ...
  public static void main(String args[]) {
    ...
    ArrayList<Character> Twelve = new ArrayList<Character>();
    for (int i=0;i<animal.length;i++)   // 將字元陣列的內容加到集合
      Twelve.add(new Character(animal[i]));

    System.out.println("集合的大小為 " + Twelve.size());
    System.out.println("集合內容為：" + Twelve); // 列出所有元素

    Twelve.add(1,new Character('牛'));  // 插入 3 個元素
    Twelve.add(6,new Character('馬'));
    Twelve.add(7,new Character('羊'));
